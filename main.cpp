...
//#if 0
	...
	delay(100);
	//右旋回して
	Trapezoid(TurnRight,0.4,500); //要調整
	//止まる
	Stop(0);
	delay(100);
	//壁に向かって前進して
...
//#endif
	...
	Front(0.15);
	//ある程度離れたら
	while(GetSonic(sonic_1)<0.000500); //要調整 100mm程度
	//止まる
	Stop(0);
	delay(100);
	//右に進み
	Right(0.15);
	//左の超音波センサが反応したら
	while(GetSonic(sonic_2)>0.002000); //要調整
	//止まる
	Stop(0);
	delay(200);

	//3.右射出
	std::cout << "3.右射出" << std::endl;
